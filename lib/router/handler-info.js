...
HandlerInfo.prototype = {
  ...
  resolve: function(shouldContinue, payload) {
    ...
    return config.Promise.resolve(undefined, this.promiseLabel("Start handler"))
  ...
  runSharedModelHook: function(payload, hookName, args) {
    ...
    return config.Promise.resolve(result, this.promiseLabel("Resolve value returned from one of the model hooks"));
  },
  ...
  checkForAbort: function(shouldContinue, promiseValue) {
    return config.Promise.resolve(shouldContinue(), this.promiseLabel("Check for abort")).then(function() {
